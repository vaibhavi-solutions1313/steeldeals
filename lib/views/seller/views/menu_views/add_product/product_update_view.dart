...
class ProductUpdateView extends StatefulWidget {
  ...
  const ProductUpdateView({Key? key, this.id, this.name, required this.sizes, this.categoryId, this.price, this.random, this.clearCut, this.description, this.categoryInfo})
      : super(key: key);
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      sizeController.getCategories().whenComplete(() {
        // print(sizeController.categoryList);
                                        ...
                                        Flexible(
                                          child: Padding(
                                            ...
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(color: Colors.orangeAccent.withOpacity(0.3), borderRadius: BorderRadius.circular(4)),
                                              child: Text(
                                                "Note : You can not update size measurements.",
                                                style: TextStyle(color: Colors.black.withOpacity(0.75)),
                                              ),
                                            ),
                                          ),
