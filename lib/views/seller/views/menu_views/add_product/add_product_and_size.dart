              ...
              Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: const Align(
                        alignment: Alignment.centerLeft, child: Text("Add Product", style: TextStyle(color: Color(0xFF213C63), fontSize: 21, fontWeight: FontWeight.w700))),
                  ),
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 18.0),
                    child: const Align(
                                              ...
                                              (val) {
                                                ...
                                                return DropdownMenuItem<String>(
                                                  onTap: () {
                                                    ...
                                                    sizeController.measurementFields.clear();
                                                    sizeController.selectedSizesList.clear();
                                                    for (var a in val['measurement_attributes']) {
                                                      sizeController.measurementFields.add(TextEditingController());
                              ...
                              Expanded(
                                child: Obx(
                                  () => TextButton(
                                    ...
                                    child: Text(
                                      sizeController.imagePath.isNotEmpty ? "Product Image Selected" : "Select Base Product Image",
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                                                                                  ...
                                                                                                  child: Column(
                                                                                                    ...
                                                                                                    children: [
                                                                                                      ...
                                                                                                      if (sizeController.selectedSizesList[index].heightInMm != null)
                                                                                                        Text(
                                                                                                            "Height : ${sizeController.selectedSizesList[index].heightInMm}mm"),
                                                                                                      ...
                                                                                                      if (sizeController.selectedSizesList[index].diameterInMm != null)
                                                                                                        Text(
                                                                                                            "Diameter : ${sizeController.selectedSizesList[index].diameterInMm}mm"),
                                      ...
                                      Wrap(
                                        ...
                                        children: List.generate(
                                          sizeController.selectedCategory['measurement_attributes'].length,
                                          (index) => SizedBox(
                                            width: sizeController.selectedCategory['measurement_attributes'].length == 1 ? Get.width : Adaptive.w(45),
                                            child: Padding(
                                              padding: const EdgeInsets.all(6.0),
                                              child: CustomTextField(
                                                controller: sizeController.measurementFields[index],
                                                hintText: sizeController.selectedCategory['measurement_attributes'][index].toString().replaceAll("_in_mm", "").capitalize,
                                                keyBoardType: TextInputType.number,
                                                onChange: (v) {
                                                  sizeController.updateSize();
                                                },
          ...
          Expanded(
            child: Padding(
              ...
              child: Obx(
                () => TextButton(
                  style: TextButton.styleFrom(
                      backgroundColor: sizeController.selectedSizesList.value.isNotEmpty &&
                              sizeController.productName.text.isNotEmpty &&
                              sizeController.productKgPrice.text.isNotEmpty &&
                              sizeController.random.text.isNotEmpty &&
                              sizeController.clearCut.text.isNotEmpty &&
                  ...
                  onPressed: sizeController.selectedSizesList.value.isNotEmpty &&
                          sizeController.productName.text.isNotEmpty &&
                          sizeController.productKgPrice.text.isNotEmpty &&
                          sizeController.random.text.isNotEmpty &&
                          sizeController.clearCut.text.isNotEmpty &&
